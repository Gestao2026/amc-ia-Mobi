...
4. **Modo 1:** leia também `captador/perfil-captador.md` e `captador/oferta.md`, se existirem, a seção "A oferta da assessoria" de `.claude/skills/posicionamento-captador/SKILL.md` e, quando o serviço incluir captação junto a empresas, `captador/MODELO-estudo-de-mercado.md`. Leia `minhas-oscs/{slug}/assessoria.md`, se existir: é onde vive o combinado com aquele cliente.
