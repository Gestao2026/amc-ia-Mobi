...
2. Anuncie:
   ...
   ```
3. Acione o agente `revisor-proposta`. Ele aplica os blocos A (completude), B (coerência interna), C (conformidade com o edital, teto, prazo), D (português, travessão) e E (coerência com o `perfil-osc.md`: capacidade, dados cadastrais, validade das certidões na data de submissão).
