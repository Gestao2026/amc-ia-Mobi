...
REGRAS_ARQUIVO = [
    (r"parecer-chefe\.md",          ("prod",  "projeto-completo",      "Chefe validando a estação")),
    (r"cotacoes\.md",               ("sales", "projeto-orcamento",     "Cotando preços na web")),
    (r"checklist-anexos\.md",       ("pag",   "projeto-anexos",        "Montando o checklist de anexos")),
    (r"documentos/declaracao-",     ("pag",   "projeto-anexos",        "Gerando declarações do edital")),
    (r"contrato-assessoria\.md",    ("pag",   "contrato",              "Minutando o contrato de assessoria")),
    (r"contrato/analise-termo",     ("pag",   "contrato",              "Analisando o termo do financiador")),
    ...
    (r"revisao\.md",                ("copy",  "projeto-revisar",       "Fazendo a revisão final")),
...
REGRAS_AGENTE = {
    "captador-chefe":        ("prod",  "projeto-completo",      "Chefe conduzindo a linha de montagem"),
    "captador-contrato":     ("pag",   "contrato",              "Preparando o contrato"),
    "captador-anexos":       ("pag",   "projeto-anexos",        "Gerando declarações e anexos"),
    "minerador-web":         ("data",  "edital-minerar",        "Varrendo a web por editais"),
