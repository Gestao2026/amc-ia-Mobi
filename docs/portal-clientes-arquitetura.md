...
5. Pacote 2 escrito e aprovado em 14/09 (`docs/portal-clientes-pacote-2-blindagem.md`). Enviado, mas o Lovable só leu e parou (1,1 crédito), e a continuação foi recusada por falta de crédito. Nada aplicado. Enviar só a continuação quando houver crédito e, logo depois, `docs/portal-clientes-nome-da-organizacao.md` (nome da organização editável, antecipado do pacote 11 a pedido da captadora em 14/09). Seguir assim com cada pacote.
