"""
Armazenamento em memoria da Camada 1 (Claude.ai <-> mcp-instagram):
...
if TYPE_CHECKING:
    ...
    from mcp_instagram.auth_instagram.token_store import CredentialBackend
...
PREFIXO_ALVO_ACCESS = "mcp-instagram:claude-access"
PREFIXO_ALVO_REFRESH = "mcp-instagram:claude-refresh"
