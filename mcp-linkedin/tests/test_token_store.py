...
Client ID ou Client Secret reais do LinkedIn.
"""

import pytest

from mcp_linkedin.auth_linkedin.token_store import TARGET_NAME, TokenStore
...
def test_target_name_padrao_e_especifico_do_componente():
    assert TARGET_NAME == "mcp-linkedin:linkedin-access-token"
