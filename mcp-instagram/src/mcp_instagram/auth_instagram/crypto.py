"""
Cifragem em envelope do access token do Instagram (Camada 2), para
...
(INSTAGRAM_TOKEN_ENCRYPTION_KEY, um secret no Render). Banco e chave
...
def generate_key_base64() -> str:
    ...
    INSTAGRAM_TOKEN_ENCRYPTION_KEY. Usada pelo operador uma unica vez,
