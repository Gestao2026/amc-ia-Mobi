...
5. Pacote 2 escrito e aprovado em 14/09 (`docs/portal-clientes-pacote-2-blindagem.md`). Enviado, mas o Lovable só leu e parou (1,1 crédito), e a continuação foi recusada por falta de crédito. Nada aplicado. Enviar só a continuação quando houver crédito. Seguir assim com cada pacote.
