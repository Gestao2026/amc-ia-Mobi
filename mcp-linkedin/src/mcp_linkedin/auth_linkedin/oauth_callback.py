"""
Processamento logico do callback OAuth do LinkedIn (Camada 2,
mcp-linkedin -> LinkedIn).
...
Nao executa OAuth real, nao acessa o LinkedIn, nao usa Client ID ou
...
def process_callback(
    ...
    3. so depois disso, verifica se o LinkedIn retornou erro OAuth;
    ...
    if params.error:
        return CallbackResult(
            ...
            detail="LinkedIn retornou um erro OAuth no callback.",
