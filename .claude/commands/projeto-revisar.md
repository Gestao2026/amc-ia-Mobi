...
2. Anuncie:
   ...
   ```
3. Acione o agente `revisor-proposta`. Ele aplica os blocos A (completude), B (coerência interna), C (conformidade com o edital, teto, prazo, anexos da inscrição), D (português, travessão) e E (coerência com o `perfil-osc.md`: capacidade, dados cadastrais, validade das certidões na data de submissão).
4. Apresente o relatório e informe o caminho do `revisao.md` salvo: itens já corrigidos, itens que exigem decisão do captador, e o veredito PRONTO PARA SUBMETER ou AJUSTAR ANTES.
