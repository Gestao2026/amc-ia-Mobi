...
> - **Teste de comportamento feito em 14/09, com o OK da captadora**, num bloco único encerrado por erro proposital (tudo desfeito; conferido depois: 0 editais, 0 registros, 0 usuários de teste, 1 convite, 1 perfil). Com um cliente fictício e um edital de teste: pergunta forjada como "administradora" gravou como cliente, com o autor e a hora reais; marcação e documento com data de 2020 gravaram a hora real; cliente não altera nem apaga registro (sem permissão), e nem o dono do banco altera (gatilho); sem login não lê organizações; apagar de vez edital em andamento é recusado; em Apagados, apaga, e o registro fica com as duas linhas, sem vínculo e com o nome do edital; convite repetido com maiúsculas e espaços é recusado com a mensagem certa. **Todos passaram.**
>
